...
El apartado 4a lo intentó realizar Pablo pero Dámaso arregló el código ya que la rutas y los parámetros estaban llamados de diferentes formas en los distintos archivos. Tuvimos que devolver una lista con las cadenas ordenar alfabéticamente.
Dámaso arregló el punto 4a y fue buscando las posibles soluciones del puntos 3a. Además, ayudó en los apartados que se atascaron y se encargó de la comunicación con el cliente.
"""
...
def get_listas():
    ...
    str = request.args.get('value')        #type: str
